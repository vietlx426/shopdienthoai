        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-3 col-xs-12 jtv-logo-block">
              ...
              <!-- Header Logo -->
              <div class="logo"><a title="e-commerce" href="{{ url('/') }}"><img alt="DTH166369" title="DTH166369" src="{{ asset('documents/website') }}/{{ $logo->image }}" style="max-height: 90px;"></a> </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-4 col-xs-12 collapsed-block">
          <div class="footer-links">
            <h3 class="links-title">Trương Quốc Việt | DTH166369  <a class="expander visible-xs" href="#TabBlock-5">+</a></h3>
            <h3 class="links-title">Lê Hữu Phước | DTH166331  <a class="expander visible-xs" href="#TabBlock-5">+</a></h3>
            <h3 class="links-title">Định Hoài Nam | DTH166318  <a class="expander visible-xs" href="#TabBlock-5">+</a></h3>
